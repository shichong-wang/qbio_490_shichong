...
write.csv(clinical, "/home1/shichong/490_cluster/analysis_data/brca_clinical_data.csv", row.names = FALSE)
```
...
```{r Exercise 3.4}
# write code here
maf_object@data[1:110,"Tumor_Sample_Barcode"]
maf_object@clinical.data[1:110,"Tumor_Sample_Barcode"]
```

What do you notice about these two lists?
In @clinical.data, Barcode does not repeat while it repeats in @data
