...
```{r setup Exercise 2.3}
    ...
    knitr::opts_knit$set(root.dir = normalizePath("~/490_cluster")) 
```
...
age <- 20
birthday <- 01/26/2004
three_fav_colors <- c("Blue", "Green", "Pink")
...
To get extra credit, email completed assignments to "[kaylaxu\@usc.edu](mailto:kaylaxu@usc.edu){.email}" when prompted. You will receive 0.25 points for completion of any swirl exercise, with a max of 5 points to be added to your homework grade.
